...
+
You can manage standalone runtimes by using cloud control planes (US Cloud, EU Cloud) or a customer-hosted control plane (Anypoint Platform PCE). MuleSoft Government Cloud does not support standalone runtimes.
